...
\subsection{TVI:}
\subsubsection{Plot Diagrammm Belastete Spannungsquelle}
\label{scr:BelSpannungsquelle}
\begin{scriptsize}
\lstset{style=python}
...
\end{scriptsize}
\subsection{TVII:}
\subsubsection{Ohmscher Widerstand Kennlinie Plot}
\label{scr:OhmscherWiderstandPlot}
\begin{scriptsize}
\lstset{style=python}
\begin{lstlisting}[language=python]
import numpy as np
...
ax.legend()
ax.set_title(r"$I(U)$-Diagramm zur Ueberpruefung des Ohm'schen Gesetzes")
# plt.show()
